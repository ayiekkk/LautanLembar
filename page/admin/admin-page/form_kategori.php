...
$data_product = $koneksi->query("SELECT * FROM genre ORDER BY ID_genre");
?>
  ...
  <div class="container mt-5">
    <div class="card shadow-lg p-4 rounded-4 mb-4">
      ...
      <form action="" method="POST">
        <div class="mb-3">
          <label class="form-label">ID_genre</label>
          <input type="text" name="IDproduct" class="form-control" placeholder="Masukkan ID genre" required>
        </div>

        <div class="mb-3">
          <label class="form-label">genre</label>
          <textarea name="product" class="form-control" rows="3" placeholder="Tuliskan nama genre"></textarea>
        </div>
